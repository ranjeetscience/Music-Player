 ...
 */
public class HistoryPlayListViewHolder extends RecyclerView.ViewHolder {
    public ImageView thumbnail,btPlay,btDownload,btFavorite;
    public TextView tvName,tvArtist,tvTime;
    public CardView cardView;

    public HistoryPlayListViewHolder(View itemView) {
        super(itemView);
